...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  LALT(KC_GRV),  KC_LCTL, KC_LGUI, KC_LALT, LOWER, SFT_T(KC_SPC), SFT_T(KC_ENT), RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_GAME] = LAYOUT_preonic_grid( \
  ...
  KC_LSFT,      KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_MINS, \
  LALT(KC_GRV), KC_LCTL, KC_LGUI, KC_LALT, LOWER, KC_SPC, KC_ENT, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Game  |Colemk|Dvorak|      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
