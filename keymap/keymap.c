 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  -   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | IME  |      | Alt  | GUI  |Lower |Space |Enter |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  LALT(KC_GRV),   KC_NO,   KC_LGUI, KC_LALT, LOWER, KC_SPC, KC_ENT, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
 ...
 * |      |      | MS_U |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | MS_L | MS_D | MS_R |      |      |      | BTN1 | BTN2 | BTN3 | BTN4 |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Reset |Debug |AGnorm|AGswap       |             | WH_L | WH_D | WH_U | WH_R |      |
 * `-----------------------------------------------------------------------------------'
 */
/*[_ADJUST] = LAYOUT_preonic_grid( \
  _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, KC_MPRV,  KC_MNXT, KC_MPLY, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, AG_NORM, AG_SWAP, QWERTY,   _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, _______, \
  _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______, _______, _______, _______, _______, _______, _______, \
  RESET,   DEBUG,  AG_NORM, AG_SWAP,  _______, _______, _______, _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R \
),
...
[_NICOLA] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, JP_U,    JP_SI,   JP_TE,   JP_KE,    JP_SE,  JP_HA,  JP_TO,    JP_KI,   JP_I,    JP_NN,    KC_QUOT,  \
  KC_LSFT, FL_STOP, JP_HI,   JP_SU,   JP_HU,    JP_HE,  JP_ME,  JP_SO,    JP_NE,   JP_HO,   JP_DOT,   FL_COMMA, \
  QWERTY,  KC_NO,   KC_LGUI, KC_LALT, NICOLA_L, KC_SPC, KC_ENT, NICOLA_R, KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT   \
),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
   ...
   //case KC_RGUI:
   //case KC_RSFT:
   //   if (is_nicola && record->event.pressed) {
   //     layer_on(_QWERTY);
   //   }
   //   if (is_nicola && record-event.released) {
   //     layer_on(_NICOLA);
   //   }
   //
   //   return false;
